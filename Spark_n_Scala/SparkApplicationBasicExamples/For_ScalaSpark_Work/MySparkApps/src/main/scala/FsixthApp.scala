...
/*Remember to pass file paths as arguments
 * C:\Users\Win10\Desktop\After_Markings_SMPC522A1DC0040_SE-PGA454_20171012_082108_FileInfo.txt
C:\Users\Win10\Desktop\Before_Markings_SMPC522A1DC0040_SE-PGA454_20171012_082108_FileInfo.txt*/
...
val outputPath = "C:\\Users\\Win10\\Downloads\\For_ScalaSpark_Work\\MySparkApps\\Outps" + "\\" + java.util.UUID.randomUUID.toString
...
x1.saveAsTextFile("C:\\Users\\Win10\\Downloads\\For_ScalaSpark_Work\\MySparkApps\\Outps\\" + DataNeeded + java.util.UUID.randomUUID.toString )
...
finalDF.orderBy("framenumber").repartition(1).write.format("json")
.save("C:\\Users\\Win10\\Downloads\\For_ScalaSpark_Work\\MySparkApps\\Outps\\" + DataNeeded + java.util.UUID.randomUUID.toString)
//finalDF.write.format("csv").save("C:\\Users\\Win10\\Downloads\\For_ScalaSpark_Work\\MySparkApps\\Outps\\" + DataNeeded + + java.util.UUID.randomUUID.toString)

finalDF.orderBy("framenumber").show(10)
finalDF.printSchema()
sc.stop()
}